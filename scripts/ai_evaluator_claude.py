...
Using Claude Haiku 4 for cost-effective evaluation (~$1.50 for 1000 notes)
...
def evaluate_note_with_ai(client, patient_summary: str, note_text: str, case_id: str, note_label: str) -> Dict:
    """
    Evaluate a single clinical pharmacist note using Claude Haiku API
    """
...
def main():
    """
    Main evaluation pipeline using Claude Haiku
    """
